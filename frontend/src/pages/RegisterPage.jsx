...
export default function RegisterPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setFormError(getErrorMessage(err, t, t.registerErrorDefault));
    }
  }
        ...
        <form onSubmit={handleSubmit} className="space-y-[16px]">
          ...
          <div>
            ...
            <div className="relative">
              <input
                className={`h-[42px] w-full rounded-[8px] border px-[14px] pr-10 text-[14px] outline-none transition-all duration-150 focus:border-indigo-500 ${
                  isDark 
                    ? "border-slate-800 bg-slate-950/60 text-slate-200 placeholder-slate-600" 
                    : "border-slate-200 bg-slate-50 text-black placeholder-slate-400"
                }`}
              ...
              <button
                type="button"
                className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 focus:outline-none transition-colors ${
